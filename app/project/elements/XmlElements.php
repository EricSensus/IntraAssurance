...
class XmlElements{
    ...
    private function _initDocument($filename, $formatting = false){
        ...
        if(!@$xmlDoc->load($filename)){
            ...
            App::critical_error('<strong>'.$errors['message'].'</strong><br>'.$errors['file'].' Line:'.$errors['line']);
        }
            ...
            if($domobject->hasAttribute($attr)){   
                ...
                elseif($attr == 'primary'){
                    ...
                    switch ($domobject->getAttribute($attr)){
                        ...
                        case 'true':
                            if(!is_array($element_array[$e_name][ 'primary' ]))
                                $element_array[$e_name][ 'primary' ] = array($domobject->nodeValue); 
                            else
                                array_push($element_array[$e_name][ 'primary' ], $domobject->nodeValue); 
                            break;
