...
HTML::script('$(document).ready(function () {
                    $("form#eform").submit(function (e) {
                        e.preventDefault(); //prevent default form submit
                    });

                    $("#entity_field_type").change(function(){
                        var $form = $(\'#entityfieldform\').data(\'Zebra_Form\');
                    ...
                    $("button#save_field_button").bind(\'click\',function() { 
                        var $form = $(\'#entityfieldform\').data(\'Zebra_Form\');
                        var fdata = $(\'#entityfieldform\').serialize();
...
echo '<table cellspacing="0" cellpadding="0">'
    . '<tr class="row">'
    . '<td>' . $label_entity_field_name . '</td>'
    . '<td>' . $entity_field_name . '</td>'
    . '</tr>';
echo '<tr class="row">'
    . '<td>' . $label_entity_field_type . '</td>'
    . '<td>' . $entity_field_type . '</td>'
    . '</tr>';
echo '</table>'
    . '</div>';
