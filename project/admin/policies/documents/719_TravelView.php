...
class TravelView extends View{
    ...
    public function stepOne($countries){
        $form = [
            ...
            'controls' => [
                ...
                'Proposer Surname *' => ['text','proposer_surname', '', ['class'=>'form-control', 'required'=>'']],
                'Other Names *' => ['text','other_names', '', ['class'=>'form-control', 'required'=>'']],
                'Date of Birth *' => ['text','dob', '', $dobs, ['class'=>'form-control datepicker','required'=>'']],
                'Passport No *' => ['text','passport_no', '', ['class'=>'form-control', 'required'=>'']],
                'Postal Address *' => ['text','postal_address', '', ['class'=>'form-control', 'required'=>'']],
                'Mobile No *' => ['text','mobile_no', '', ['class'=>'form-control', 'required'=>'']],
                ...
                'Address at Destination' => ['text','addess_at_destination', '', ['class'=>'form-control', 'required'=>'']],
                'Phone at Destination' => ['text','phone_at_destination', '', ['class'=>'form-control', 'required'=>'']],
                'Travel Airline Company' => ['text','travel_airline_company', '', ['class'=>'form-control', 'required'=>'']],
    ...
    public function stepTwo(){
        $form = [
            ...
            'controls' => [
                ...
                'If No, Please provide particulars' => [
    ...
    public function loadControls($no_travel_companions){
        ...
        [
            ...
            'Plans' => [
                'radios', 'cover_plan', [
                    'africa_basic_plan' => 'Africa Basic Plan - Covers you upto a limit of US$15000 for medical expenses and hospitalization abroad plus...',
                    'europe_plus_plan' => 'Europe Plus Plan - Covers you upto a limit of US$45000 for medical expenses and hospitalisation abroad plus...',
                    'world_wide_basic_plan' => 'World Wide Basic Plan - Covers you upto a limit of US$45000 for medical expenses and hospitalisation abroad plus...',
                    'world_wide_plus_plan' => 'World Wide Plus Plan - Covers you upto a limit of US$67500 for medical expenses and hospitalisation abroad plus...',
                    'world_wide_extra' => 'World Wide Extra - Covers you upto a limit of US$150000 for medical expenses and hospitalisation abroad plus...',
                    'haj_and_umrah_basic_plan' => 'Haj & Umra Basic Plan - Covers you upto a limit of US$10000',
                    'haj_and_umrah_plus_plan' => 'Haj & Umra Plus Plan - Covers you upto a limit of US$10000',
                    'haj_and_umrah_extra_plan' => 'Haj & Umra Extra Plan - Covers you upto a limit of US$10000'
                ],[
                    'required' => ''
                ]
            ],
            ...
            '{note2}' => ['note', 'note2', 'note2', '<p><strong>The liability of the Jubilee Insurance Company of Kenya Limited does not commence until the proposal has been accepted and the premium paid and cover confirmed by Jubilee.</strong></p>
