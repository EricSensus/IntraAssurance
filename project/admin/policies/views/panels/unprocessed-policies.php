...
HTML::script('$(document).ready( function () {
                $("#policiestable").ready(function(){
                    $("#policiestable_paginate").appendTo($(".policy-pagination"));
                });
            } );');
...
?>
    ...
    <div class="mini-panel">
        <div class="float-left">
            <h4 class="mb5 text-light">Unprocessed Policies (<?php echo $count; ?>)</h4>
        </div>
    ...
    <?php
        echo $unprocessedtable;
    ?>
    </div>
    <div class="dataTables_wrapper panel-footer">
        <div class="float-left">
            <p><strong>Shows</strong> the policies which haven't been processed</p>
        </div>
        <div class="float-right policy-pagination">
        </div>
    </div>
