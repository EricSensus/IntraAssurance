...
echo '<table cellspacing="0" cellpadding="0">'
    . '<tr class="row">'
    . '<td width="30%">' . $label_product_field_name . '</td>'
    . '<td width="70%">' . $product_field_name . '</td>'
    . '</tr>';
echo '<tr class="row">'
    . '<td>' . $label_product_field_type . '</td>'
    . '<td>' . $product_field_type . '<span class="small" style="font-size:10px;color:red;"><strong>*To change field type, please delete this field and recreate again<strong></span></td>'
    . '</tr>';
echo '</table>'
    . '</div>';
