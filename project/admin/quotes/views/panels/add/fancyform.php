...
<div class="customer_product_information" style="width:100%; text-align: center;"></div>
...
<table class="policy entity-details table-striped">
    ...
    <tr>
        ...
        <td width="75%" class="field">
            <div class="customer_entity_select" style="width:80%; text-align: left; float: left;"></div>
            <button type="button" class="btn btn-default addentity">Add Entity</button>
        </td>
    </tr>
</table>
<div class="customer_entities" style="width:100%; text-align: left;">
