...
<table class="wizard-heading row">
    <tr class="heading row">
        <th class="heading col-md-3 col-sm-12 col-xs-12">
            <a href="<?= Url::link('/medical/step/1') ?>"><h5>
                    Stage 1</h5></a>
            <a href="<?= Url::link('/medical/step/1') ?>">
                <h6>Proposer Personal Details</h6></a>
        </th>
        <th class="heading col-md-3 col-sm-12 col-xs-12">
            <a class="active" href="<?= Url::link('/medical/step/2') ?>"><h5>
                    Stage 2</h5></a>
            <a class="active" href="<?= Url::link('/medical/step/2') ?>">
