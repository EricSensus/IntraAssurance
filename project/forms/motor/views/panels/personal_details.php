...
<div class="panel panel-default" id="step-1">
    <div class="panel-heading"><b>Motor: Step 1 of 4 - Proper Personal Details</b> (
        <small>Note: All the fields marked with an asterisk(*) are mandatory!</small>
        )
    </div>
    <div class="row form-group">
        <div class="col-xs-12">
            <ul class="nav nav-pills nav-justified thumbnail setup-panel">
                <li class="active"><a href="<?= Url::link('motor/step') ?>">
